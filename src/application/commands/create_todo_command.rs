use std::{f32::consts::E, ops::DerefMut, sync::Arc};

use crate::{api::router::AppState, domain::models::todo::{todo_to_response, Todo}, schema::CreateTodoSchema};
...
pub async fn create_todo_command(
    ...
    let query_result: Result<sqlx::mysql::MySqlQueryResult, String> = sqlx::query(r#"INSERT INTO todos (title, content) VALUES (?, ?)"#)
        .bind(&body.title)
        .bind(&body.content)
